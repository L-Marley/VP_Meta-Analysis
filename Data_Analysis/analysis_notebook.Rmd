...
```{r vivid_bfor}
# Define study labels
viv_bfor_labs <- c("McIsaac & Eich, 2002",
...
```
The 8th study in the model (Sekiguchi & Nonaka, 2017) appears to be an outlier and influential on the other cases.

This matches with what is shown in the forest plot with their study suggesting third-person perspective is more vivid and the confidence interval does not cross zero. 

Having checked this paper again and looking at the values this is due to a coding error by myself. 

Study 2 is also contributing greatly to QF. 
